              ...
              <div className={styles.container}>
                ...
                <div className={`eye ${passwordShow.input2 ? 'show':''}`} onClick={()=>{
                    setPasswordShow({...passwordShow, input2: !passwordShow.input2})
                      ...
                      <span onClick={submit} className={`btn ${!submittedForm.formTouched || submittedForm.error || copyPassword !== newPassword || submittedForm.submitting || !newPassword.length ? 'disable':''}`}>Update Password</span>
