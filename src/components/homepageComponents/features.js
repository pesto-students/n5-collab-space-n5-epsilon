...
return <section className="choose-cypherchange">
    <div className="landing-container">
        <div className="section-intro">
            <h3>Why choose Cypherchange</h3>
        ...
        <div className="outer-wrapper">
            ...
            <div className="feature" data-sal="slide-up"
                ...
                <div className="content-wrapper">
                    <h4>Defining transaction limits</h4>
            ...
            <div className="feature" data-sal="slide-up"
                ...
                <div className="content-wrapper">
                    ...
                    <p>Majority of users digital assets are stored in offline environment.</p>
                </div>
            </div>
        </div>
    </div>
